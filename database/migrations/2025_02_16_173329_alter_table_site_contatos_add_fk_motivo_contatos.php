...
class AlterTableSiteContatosAddFkMotivoContatos extends Migration
{
    ...
    public function up()
    {
        //adicionando a coulna motivo_contatos_id
        ...
        //criacao da FK e removendo a coluna motivo_contato
        Schema::table('site_contatos', function (Blueprint $table) {
    ...
    {
        //criar a coluna motivo_contato e remover a fk(<table>_<coluna>_foreign)
        Schema::table('site_contatos', function (Blueprint $table) {
